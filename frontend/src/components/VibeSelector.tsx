...
const styles = StyleSheet.create({
  ...
  counterBadgeEmpty: { backgroundColor: 'rgba(255,0,0,0.1)', borderColor: 'rgba(255,0,0,0.3)' },
  ...
  closeButton: {
    width: 32, height: 32, backgroundColor: 'rgba(255,255,255,0.08)',
  ...
  messagePillActive: { backgroundColor: 'rgba(255,215,0,0.15)', borderColor: COLORS.gold.primary },
  ...
  customInputContainer: { marginHorizontal: 20, marginTop: 14 },
  customInput: {
    backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12,
    borderWidth: 1, borderColor: COLORS.gold.primary,
    padding: 14, fontSize: 15, color: COLORS.text.primary,
  },
  charCount: { fontSize: 12, color: COLORS.text.muted, textAlign: 'right', marginTop: 4 },
  charCountMax: { color: '#FF5533' },
  preview: {
    marginHorizontal: 20, marginTop: 16, padding: 14,
    backgroundColor: 'rgba(255,215,0,0.07)', borderRadius: 12,
    borderLeftWidth: 3, borderLeftColor: COLORS.gold.primary,
  },
  previewQuote: { fontSize: 15, color: COLORS.gold.primary, fontStyle: 'italic', fontWeight: '500' },
  ...
  premiumBtn: { backgroundColor: COLORS.gold.primary, borderRadius: 12, paddingHorizontal: 24, paddingVertical: 12 },
