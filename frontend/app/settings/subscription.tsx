...
const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      { text: 'Ver quién respondió tus invitaciones', included: true },
      { text: 'Vibes ilimitados', included: false },
      { text: 'Modo Fantasma', included: false },
      { text: 'Ver perfiles completos', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Ver perfiles completos', included: true, highlight: true },
      { text: 'Ver reviews y calificaciones', included: true },
      { text: 'Buscar usuarios específicos', included: true, highlight: true },
      { text: 'Enviar invitaciones directas', included: true, highlight: true },
